...
const isDatabasePrepared = ({ client }) =>
  client.query(
    Q.And(
      Q.Exists(Q.Index("latestEntries")),
      Q.Exists(Q.Function("listLatestEntries")),
      Q.Exists(Q.Role("GuestbookRole"))
    )
  );
...
const main = async () => {
  ...
  console.log(await client.query(Q.Call(Q.Function("listLatestEntries"), [10, null, null])))
